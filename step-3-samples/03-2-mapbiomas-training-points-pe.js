...
(function init(param) {
  ...
  var assets = {
    ...
    stablePixels:paths.muestrasestables + param.country + '/COLECCION5/MUESTRAS_ESTABLES/muestras-estables/',
    classAreas: 'projects/mapbiomas-raisg/MUESTRAS/'+ param.country +'/COLECCION5/AREAS_CLASE_REGION/',
    outputs: 'projects/mapbiomas-raisg/MUESTRAS/'+ param.country +'/COLECCION5/PUNTOS_ESTABLES/'
  };
