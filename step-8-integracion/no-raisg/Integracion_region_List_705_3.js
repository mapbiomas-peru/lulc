...
var geometry = 
    ...
    ee.Geometry.Polygon(
        [[[-80.90004350329218, -5.976183243795655],
          [-80.90004350329218, -6.127768927979312],
          [-80.74417497301874, -6.127768927979312],
          [-80.74417497301874, -5.976183243795655]]], null, false);
...
var param = {//region, version
    ...
    pais: 'PERU',
    years: [1985,2022],  // Solo visualizacion
    versionGeneral : '2',
...
var mosaictransv9 = ee.ImageCollection('projects/mapbiomas-raisg/TRANSVERSALES/PERU/COLECCION5/AGRICULTURA/PRE_INTEGRACION/plantacion_costa')
                ...
                .byte()
                .selfMask();
print('mosaictransv9',mosaictransv9)
...
print('mosaictransv18',mosaictransv18)
...
print('mosaictransv21',mosaictransv21)
...
// var mining30_andes = ee.Image('projects/mapbiomas-raisg/TRANSVERSALES/PERU/COLECCION5/MINERIA/clasificacion/MINERIA-704-PERU-1').byte()
// var mining30_costa = ee.Image('projects/mapbiomas-raisg/TRANSVERSALES/PERU/COLECCION5/MINERIA/clasificacion/MINERIA-705-PERU-2').byte()

// var mining30 =  ee.ImageCollection([mining30_andes, mining30_costa]).mosaic()
//                 .eq(30).multiply(30)
//                 .byte()
//                 .selfMask();

// var mining30 = mining30_costa.eq(30).selfMask()
//                             // .blend(mining30_costa.eq(30).selfMask())
//                               // .mask()  // agrega 0 a todos fuera del mask 
//                               .multiply(30)
//                               .updateMask(regionMosaicRaster)
//                               .byte()
//                               .selfMask()
...
print('acuicultura31',acuicultura31)
...
param.code_regions.forEach(function(region){
  ...
  list_integrate.forEach(function(clase) {
          ...
          // integracion_v1 = integracion_v1.where(ee.Image(assetsClasificaciones[clase[0]+'-'+clase[1]]),ee.Image(assetsClasificaciones[clase[0]+'-'+clase[1]]))
  });
...
// if(region===70504){
//   Map.addLayer(regionsRaster,{},'regionsRaster'+region,false)
//   Map.addLayer(integracion_v1,{},'integracion_v1'+region,false)
//   Map.addLayer(regioV.geometry().bounds(),{},'regioV'+region,false)
// }
