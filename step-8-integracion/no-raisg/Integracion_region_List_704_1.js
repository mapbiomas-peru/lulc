...
var mining30 = ee.ImageCollection('projects/mapbiomas-raisg/TRANSVERSALES/PERU/COLECCION5/MINERIA/clasificacion')
                 .filter(ee.Filter.inList('region', [704,705]))
                 .map(function(imag){ return imag.toByte()})
